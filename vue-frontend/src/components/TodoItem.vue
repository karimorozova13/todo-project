<template>
  ...
  <svg v-if="isCompleted" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="green" class="size-20">
  ...
  <RouterLink :to="`/my-todo-list/${el._id}`">Read more</RouterLink>
  <div class="buttons">
